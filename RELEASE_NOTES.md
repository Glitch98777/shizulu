...
- Store filter/sort and backend selector buttons now refresh their selected styling immediately, so stale highlighted buttons no longer stick around after changing modes.
